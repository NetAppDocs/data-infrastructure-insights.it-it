...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Avviso per Data Infrastructure Insights (in precedenza Cloud Insights), window=_blank"]

link:media/DII_WS_Notice_Nov2025.pdf["Avviso per Workload Security (in precedenza Cloud Secure), window=_blank"]
