...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Avviso per Data Infrastructure Insights (in precedenza Cloud Insights)"]

link:media/DII_WS_Notice_Nov2025.pdf["Avviso per la sicurezza del carico di lavoro (in precedenza Cloud Secure)"]
