...
summary: 'Configura i data collector Workload Security per Cloud Volumes ONTAP e Amazon FSx for NetApp ONTAP per monitorare l"accesso ai file, l"attività degli utenti e rilevare le minacce nell"infrastruttura di archiviazione cloud.' 
---
