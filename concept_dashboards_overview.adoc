...
summary: 'Crea dashboard personalizzate con widget flessibili per visualizzare i dati dell"infrastruttura, monitorare le tendenze delle prestazioni e creare viste operative su misura per le tue specifiche esigenze di monitoraggio.' 
...
[role="lead"]
Crea dashboard personalizzate che ti forniscano le informazioni operative di cui hai più bisogno. Scegli tra diversi tipi di widget, tra cui tabelle, grafici, indicatori e diagrammi, per visualizzare i dati della tua infrastruttura esattamente come vuoi, permettendo decisioni migliori e un monitoraggio più efficace.
