...
summary: 'Accedi ai dati di Workload Security tramite un"API REST con autenticazione sicura basata su token per integrarti con CMDB, sistemi di ticketing e altre applicazioni aziendali.' 
---
