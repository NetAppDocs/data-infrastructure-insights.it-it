...
summary: 'Accedi a informazioni centralizzate sulla gestione dello storage con report completi sull"utilizzo della capacità, le tendenze delle prestazioni e le previsioni delle risorse per una gestione proattiva del data center.' 
...
[role="lead"]
La dashboard di Storage Manager offre informazioni centralizzate sull'ambiente di storage tramite report e visualizzazioni complete. Monitora l'utilizzo della capacità, tieni traccia delle tendenze delle prestazioni nel tempo e confronta le metriche attuali con gli intervalli accettabili per prendere decisioni informate sulla manutenzione del data center e sulla pianificazione delle risorse.
