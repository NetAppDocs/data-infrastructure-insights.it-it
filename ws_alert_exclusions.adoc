...
. Tipi di file: sopprimi gli avvisi di manomissione dei file su specifici <<file-types,Tipi di file consentiti>>
...
* Elenco di esclusione delle directory: supporta fino a quattro livelli di percorsi di directory, a partire dal percorso di giunzione. Tutte le sottodirectory e i file presenti in questo percorso saranno esclusi dalla generazione degli avvisi. I caratteri jolly nei percorsi di directory non sono supportati.


image:ws_alert_exclusions_users.png["Utenti esclusi dagli avvisi"]

image:ws_alert_exclusions_paths.png["Percorsi di esclusione degli alert"]
