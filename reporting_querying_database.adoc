...
summary: Accedi direttamente al database di reporting tramite API, bypassando Cognos per integrazioni personalizzate, reporting automatizzato e flussi di lavoro avanzati di analisi dei dati. 
...
[role="lead"]
Accedi direttamente al database di Data Infrastructure Insights Reporting tramite API conformi a OData v4, bypassando l'interfaccia Cognos per una maggiore flessibilità. Questo consente integrazioni personalizzate, flussi di lavoro di reporting automatizzati e analisi avanzate dei dati per chi ha bisogno di accesso programmatico ai dati della propria infrastruttura.
...
L'API Data Infrastructure Insights Reporting segue lo link:https://www.odata.org/["OData v4"] standard (Open Data Protocol) per l'interrogazione del database di Reporting. Per saperne di più, dai un'occhiata a link:https://www.odata.org/getting-started/basic-tutorial/["questo tutorial"] su OData.
