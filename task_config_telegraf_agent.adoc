...
TIP: Una volta installato un agente su un server/VM, Data Infrastructure Insights raccoglie metriche da quel sistema, oltre a raccoglierle da qualsiasi data collector che configuri. Queste metriche vengono raccolte come metriche "Node".
