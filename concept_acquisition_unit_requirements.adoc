...
| Sistema operativo  a| 
Un computer su cui è installata una versione con licenza di uno dei seguenti:
...
Su questo computer non deve essere eseguito alcun altro software a livello applicativo. Si consiglia un server dedicato.
...
* /tmp almeno 1 GB disponibile durante l'installazione


Il file system potrebbe utilizzare dello spazio per le sue operazioni generali. Questi sono gli spazi minimi che dovrebbero essere disponibili prima dell'installazione.
| 50 GB 
