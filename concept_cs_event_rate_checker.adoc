...
summary: 'Utilizzare SVM Event Rate Checker per misurare le frequenze degli eventi NFS/SMB e determinare le dimensioni ottimali dell"agente prima di distribuire i data collector di Workload Security.' 
