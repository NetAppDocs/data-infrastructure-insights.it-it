...
| link:task_dc_pure_flashblade.html["Pure FlashBlade"] | Infrastruttura 
...
| link:task_dc_redhat_openshift virtualization.html[Red Hat OpenShift Virtualizzazione] | Infrastruttura 
