...
+
** Installa link:http://ldaptool.sourceforge.net/["LDAP Explorer"] o link:http://jxplorer.org/["Java LDAP Explorer"] su qualsiasi macchina Windows che può connettersi al server LDAP.
