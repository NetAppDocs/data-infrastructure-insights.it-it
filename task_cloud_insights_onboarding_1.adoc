...
Una volta creato il tenant, in qualsiasi momento puoi semplicemente accedere al portale NetApp BlueXP e passare alla link:https://services.cloud.netapp.com["Servizi cloud"] pagina e seleziona *Vai a Data Infrastructure Insights*.
