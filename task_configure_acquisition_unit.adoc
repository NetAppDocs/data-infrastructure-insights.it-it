...
Se noti che il tuo AU è bloccato mentre tenta di connettersi a DII, prova ad aggiungere questi endpoint al tuo proxy:
...
Gli endpoint proxy specifici della NetApp Console di cui potresti aver bisogno sono elencati nella link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["Configurazione console Admin"] documentazione.
