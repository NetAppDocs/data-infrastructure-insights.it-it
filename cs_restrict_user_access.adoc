...
summary: 'Arresta immediatamente gli attacchi rilevati limitando automaticamente o manualmente l"accesso degli utenti compromessi, prevenendo così ulteriori danni ai file system su più volumi di archiviazione.' 
---
