...
L'osservabilità di Data Infrastructure Insights misura l'utilizzo in base al Tier di storage del tuo ambiente. È possibile che vi siano depositi che rientrano in una o più di queste categorie:
...
Se il numero previsto di unità gestite è pari o superiore a 1.000, fare clic sul link:https://www.netapp.com/us/forms/sales-inquiry/cloud-insights-sales-inquiries.aspx["*Contattare il reparto vendite*"] pulsante per abbonarsi al team vendite NetApp.
