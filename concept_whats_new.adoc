...
Pagina di dettaglio per un potenziale attacco ransomware: vista "Schermo": i widget della tabella mostrano l'oggetto/raggruppamento sul lato sinistro e i dati dell'oggetto (attributi/metriche) sul lato destro.
...
'''
Widget valore con formattazione image:Single-Value Widgets - Formatted.png["Widget a valore singolo con formattazione"]
