...
=== L'AI Assistant di DII è disponibile per tutti!

L'assistente AI di Data Infrastructure Insights è disponibile in anteprima e ora include i seguenti miglioramenti:

* Disponibilità della regione Azure: per i clienti il cui sito DII è ospitato su Azure, il DII Assistant è ora pronto ad aiutarti.
* Fino a 7 giorni di dati: l'Assistente può ora accedere fino a 7 giorni di metriche ad alta risoluzione, consentendo analisi e approfondimenti dei dati di portata più ampia.
