...
NOTE: La raccolta delle prestazioni di Data Infrastructure Insights dai cluster VPLEX richiede che il servizio di archiviazione delle prestazioni sia operativo, al fine di popolare i file .CSV e i log che Data Infrastructure Insights recupera tramite copie di file basate su SCP. NetApp ha osservato che molti aggiornamenti del firmware/aggiornamenti della stazione di gestione VPLEX lasceranno questa funzionalità non operativa. I clienti che pianificano tali aggiornamenti potrebbero voler chiedere proattivamente a Dell/EMC se l'aggiornamento pianificato lascerà questa funzionalità inutilizzabile e, in tal caso, come possono riattivarla per ridurre al minimo le lacune nella visibilità delle prestazioni? Il codice delle prestazioni VPLEX di Cloud Insight valuterà a ogni polling se tutti i file previsti esistono e se vengono aggiornati correttamente; se sono mancanti o obsoleti, Data Infrastructure Insights registrerà errori di raccolta delle prestazioni.
