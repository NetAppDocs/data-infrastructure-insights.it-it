...
[role="lead"]
Questo raccoglitore di dati acquisisce informazioni di inventario dai sistemi di storage con deduplicazione DELL EMC Data Domain. Per configurare questo raccoglitore di dati, è necessario seguire specifiche istruzioni di configurazione e raccomandazioni d'uso.
