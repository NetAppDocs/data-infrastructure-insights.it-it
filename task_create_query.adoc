...
summary: Crea query personalizzate per cercare, filtrare e analizzare le risorse della tua infrastruttura e le metriche con un controllo granulare, raggruppamenti flessibili e visualizzazione dei risultati personalizzabile. 
...
[role="lead"]
Crea query potenti per cercare le tue risorse infrastrutturali a un livello granulare con funzionalità flessibili di filtraggio, raggruppamento e ordinamento. Crea ricerche mirate che ti aiutano a identificare asset specifici, analizzare metriche di performance e organizzare i risultati esattamente come ti servono.
