...
[role="lead"]
Data Infrastructure Insights offre opzioni di supporto complete, tra cui risorse self-service, forum della community, documentazione e supporto tecnico. Accedi a queste risorse di supporto selezionando *Aiuto > Supporto* e valuta di attivare il tuo diritto di supporto per sbloccare l'assistenza tecnica completa tramite ticket web e supporto telefonico.
...
Si raccomanda vivamente di selezionare la casella per consentire a un NetApp Support Engineer di accedere al sito Data Infrastructure Insights durante la sessione di supporto. Ciò permetterà al tecnico di individuare il problema e aiutarvi a risolverlo rapidamente. Finché il Support Engineer avrà accesso al sito, potrà svolgere tutte le funzioni a livello di amministratore.

Quando il problema sarà risolto o la sessione di supporto sarà terminata, puoi deselezionare la casella.

Puoi richiedere assistenza andando su link:https://www.netapp.com/support-and-training/["Sito di supporto NetApp"]. Devi avere un abbonamento attivo a Data Infrastructure Insights.
