...
* 4.3.1
* 4.3.3
* 4.4.1 Tipo di rilascio: Standard Support Release
* 4.5.15 Tipo di rilascio: Extended Support Release
* 4.5.18 Tipo di rilascio: Extended Support Release
* 4.5.21 Tipo di rilascio: Extended Support Release
* 4.5.24 Tipo di rilascio: Extended Support Release
* 4.5.7 Tipo di rilascio: Extended Support Release
* 4.6.1 Tipo di rilascio: Extended Support Release
* 9.5.15 Tipo di rilascio: Extended Support Release
* 9.5.8 Tipo di rilascio: Extended Support Release
* 9.6.1 Tipo di rilascio: Extended Support Release
...
* Brocade 6558
* Brocade 7800
* Switch di estensione Brocade 7810
* Brocade 7840
* Brocade DCX
...
.86+| fondazione .9+| Disco | Capacità (GB) | Implementato | HTTPS |  
...
.13+| Pool di archiviazione | Includi nella capacità DWH | Implementato | HTTPS |  
...
.18+| Volume | Identificatore di policy AutoTier | Implementato | HTTPS |  
...
.4+| fondazione .4+| Informazioni | Nome dell'origine dati | Implementato | HTTP/S | Informazioni 
...
.15+| prestazione .4+| Dati del nodo di archiviazione | Rapporto di hit della cache totale | Implementato | SSH |  
...
.110+| fondazione .15+| Disco | Capacità (GB) | Implementato |  |  
...
.7+| Nodo di archiviazione | Dimensione della cache | Implementato | HTTPS |  
