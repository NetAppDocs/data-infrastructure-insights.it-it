...
. In qualsiasi momento, se un raccoglitore di dati è in esecuzione, un altro verrà visualizzato come _Arrestato_.
+
Il raccoglitore dati dell'SVM attualmente in esecuzione verrà visualizzato come _In esecuzione_.  Il raccoglitore dati dell'SVM attualmente 'arrestato' verrà visualizzato come _Arrestato_.
