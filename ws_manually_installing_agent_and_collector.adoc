...
.. Nota: il programma di installazione dell'agente deve essere scaricato in una cartella diversa da quella in cui è in esecuzione l'agente.
...
+
Ad esempio, se l'agente è in esecuzione in "/test_user/apps", il comando sarebbe:
